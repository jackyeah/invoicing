...
oPaginate:{sFirst:"第一頁",sLast:"最後一頁",sNext:"下一頁",sPrevious:"上一頁"},sEmptyTable:"沒有資料。",sInfo:"Showing _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"顯示 _MENU_ 筆數",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"關鍵字",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
